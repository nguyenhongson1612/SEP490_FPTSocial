...
namespace Application.Queries.SearchFunction
{
    public class SearchFunctionQueryHandler : IQueryHandler<SearchFunctionQuery, SearchFunctionQueryResult>
    {
        ...
        //    //Tải trạng thái Public và Friend
        ...
        //    //Tìm các bài viết theo điều kiện tìm kiếm và trạng thái mà không chuẩn hóa nội dung
        ...
        //        .Where(p => EF.Functions.Like(NormalizeString(p.Content), $"%{normalizedSearchContent}%"))
        //        .ToList();
        ...
        //    // Tìm các bài viết theo điều kiện trạng thái mà không chuẩn hóa nội dung
