  ...
  return (
    <div className="max-h-[calc(100vh_-_55px)] hidden lg:!flex w-[380px] flex-col overflow-y-auto scrollbar-none-track text-lg font-semibold">
      <div className="ml-3 mt-8 mb-5">
        ...
        >
          <Link to={'/profile'}
            className="w-full px-2 rounded-md py-3 hover:bg-fbWhite-500 flex items-center gap-3 cursor-pointer">
            <img
          ...
          <Link className="w-full px-2 rounded-md py-3 hover:bg-fbWhite-500 flex items-center gap-3 cursor-pointer ">
        ...
        >
          ...
          <a className="w-full px-2 rounded-md py-3 hover:bg-fbWhite-500 flex items-center gap-3 cursor-pointer">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQuatIJXhoIyk41rXuz9n3cHerAI8OdrNUjzBvvYALViA&s"
              alt="group-img"
          ...
          <a
            ...
            <span className="font-semibold text-gray-900">{isMore ? 'Hide' : 'More'}</span>
          </a>
        </div>
      </div>
