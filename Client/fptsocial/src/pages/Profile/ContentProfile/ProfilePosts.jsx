...
import { IconCake, IconHeartFilled, IconHome, IconHomeFilled, IconManFilled, IconMessageCircle, IconPhoto, IconSettings, IconUserCircle } from '@tabler/icons-react'
    ...
    <div id=''
      ...
      <div
        ...
        <div className='flex flex-col p-4 gap-3'>
          ...
          <div className='flex gap-1'><IconUserCircle stroke={2} color='#c8d3e1' /><span className='font-semibold'>{user?.firstName + ' ' + user?.lastName || 'No information'}</span></div>
